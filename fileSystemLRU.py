...
class DirectoryLRU:
    ...
    def createFile(self, filename: str, data):
        ...
        try:
            ...
            f.write(data)
            # Add key (filename) to linked list
            self.link.create(filename)
    ...
    def readFile(self, filename: str, displayImage: bool=False):
        ...
        try:
            ...
            data = f.read()
            f.close()
            # Move key (filename) to head of the linked list
            self.link.delete(filename, makehead=True)
    ...
    def deleteFile(self, filename: str):
        ...
        try:
            ...
            # Delete key (filename) from linked list
            self.link.delete(filename)
